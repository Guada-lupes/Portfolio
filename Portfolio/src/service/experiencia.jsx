...
const experiencia = [
    {imagen: zoddak,
        ...
        descripcion: "Desarrollé un catálogo personalizable (color, imagenes, información) con visualización FlippedBook y descarga en Pdf en React.js.",
        em: "Expo Real Estate MArketing SL (Zoddak)",
        fecha: "2025",},
    {imagen: foto1,
        id: 2,
        alt: "imagen de una clase",
